...
const chapterDebounceTimer = null
...
.chunk-text { background: rgba(59,130,246,0.12); color: #3B82F6; }
.chunk-image { background: rgba(168,85,247,0.12); color: #A855F7; }
.chunk-table { background: rgba(34,197,94,0.12); color: #22c55e; }
