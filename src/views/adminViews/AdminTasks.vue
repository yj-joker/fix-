...
/* ========== 状态枚举 ========== */
const STATUS_MAP = {
  CREATED:         { label: '已创建',   color: '#3b82f6', bg: '#eff6ff' },
  GENERATING:      { label: '生成中',   color: '#f59e0b', bg: '#fffbeb' },
  GENERATED:       { label: '已生成',   color: '#22c55e', bg: '#f0fdf4' },
  GENERATE_FAILED: { label: '生成失败', color: '#ef4444', bg: '#fef2f2' },
  EXECUTING:       { label: '执行中',   color: '#8b5cf6', bg: '#f5f3ff' },
  CLOSED:          { label: '已关闭',   color: '#64748b', bg: '#f8fafc' },
}
const PROMO_MAP = {
  PENDING:  { label: '待沉淀', color: '#d97706', bg: '#fff7ed' },
  PROMOTED: { label: '已沉淀', color: '#16a34a', bg: '#f0fdf4' },
  SKIPPED:  { label: '已跳过', color: '#94a3b8', bg: '#f8fafc' },
}
const URGENCY_MAP = {
  0: { label: '低',   color: '#16a34a', bg: '#f0fdf4' },
  1: { label: '普通', color: '#3b82f6', bg: '#eff6ff' },
  2: { label: '紧急', color: '#ef4444', bg: '#fef2f2' },
}
      ...
      <el-tab-pane label="任务列表" name="list">
        ...
        <div class="at-table-wrap">
          <el-table
            ...
            stripe
            style="width: 100%"
            :header-cell-style="{ background: '#f8fafd', color: '#475569', fontWeight: 600, fontSize: '12px', letterSpacing: '0.4px' }"
          ...
          >
            ...
            <el-table-column prop="taskNumber" label="任务编号" width="170">
              <template #default="{ row }">
            ...
            <el-table-column prop="urgencyLevel" label="紧急等级" width="90" align="center">
              <template #default="{ row }">
                <span
                  class="tag-sm"
                  :style="{
            ...
            <el-table-column prop="promotedProcedure" label="规程沉淀" width="90" align="center">
              <template #default="{ row }">
                <span
                ...
                <span v-else class="tag-sm" style="background:#f8fafc;color:#94a3b8">-</span>
              </template>
            </el-table-column>

            <el-table-column prop="promotedGraph" label="图谱沉淀" width="90" align="center">
              <template #default="{ row }">
                <span
...
.at-title-sub {
  font-family: var(--font-mono); font-size: 10px; color: #94a3b8; letter-spacing: 2px;
}
