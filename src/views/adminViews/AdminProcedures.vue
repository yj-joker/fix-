...
/* ========== 枚举 ========== */
const STATUS = {
  DRAFT:     { label: '草稿',   color: '#64748b', bg: '#f8fafc', bar: '#94a3b8' },
  PUBLISHED: { label: '已发布', color: '#2563eb', bg: '#eff6ff', bar: '#3b82f6' },
  ARCHIVED:  { label: '已归档', color: '#16a34a', bg: '#f0fdf4', bar: '#22c55e' },
}
...
<template>
  <div class="ap-root">
    ...
    >
      ...
      <div class="dlg-section">
        <div class="dlg-section-title">
          <span class="ds-bar" style="background:#8b5cf6" />维护步骤
      ...
      <div v-if="detail.procedure" class="detail-view">
        ...
        <div class="dv-steps">
          <div class="dv-section-title">
            <span class="ds-bar" style="background:#8b5cf6" />步骤清单
          </div>
...
.ap-title-text {
  font-size: 20px; font-weight: 700; color: var(--plaza-heading); margin: 0; letter-spacing: 0.3px;
}
.ap-title-sub {
  font-family: var(--font-mono); font-size: 10px; color: #94a3b8; letter-spacing: 1.8px;
}
.ap-create-btn {
  display: flex; align-items: center; gap: 6px;
  padding: 9px 20px;
  background: var(--plaza-accent); color: #fff;
  border: none; border-radius: 10px;
  font-size: 14px; font-weight: 600; cursor: pointer;
  transition: all 0.18s ease; box-shadow: 0 2px 10px rgba(59,130,246,.28);
}
.ap-create-btn:hover { background: #2563eb; transform: translateY(-1px); box-shadow: 0 4px 16px rgba(59,130,246,.36); }
...
.proc-card:hover { transform: translateY(-3px); box-shadow: var(--plaza-shadow-organic-hover); border-color: #c8cfe0; }
...
.card-ver { font-family: var(--font-mono); font-size: 11px; color: #94a3b8; font-weight: 600; }
...
.meta-chip { font-size: 11px; font-weight: 600; padding: 2px 8px; border-radius: 6px; background: #f1f5f9; color: #475569; }
.meta-chip.steps { background: #f5f3ff; color: #7c3aed; }
.card-footer { display: flex; justify-content: space-between; align-items: center; margin-top: auto; font-size: 11.5px; color: #94a3b8; }
.card-source { font-weight: 500; }

.card-actions { display: flex; flex-direction: column; gap: 1px; width: 72px; flex-shrink: 0; border-left: 1px solid #f1f5f9; }
.ca-btn {
...
.ca-edit:hover { background: #eff6ff; color: var(--plaza-accent); }
.ca-pub:hover  { background: #f0fdf4; color: #16a34a; }
.ca-view:hover { background: #eff6ff; color: var(--plaza-accent); }
.ca-arch:hover { background: #f5f3ff; color: #7c3aed; }
...
.step-count { font-family: var(--font-mono); font-size: 12px; color: #8b5cf6; font-weight: 600; margin-left: auto; }

/* 步骤编辑器 */
.steps-editor { display: flex; flex-direction: column; gap: 10px; max-height: 400px; overflow-y: auto; padding-right: 4px; }
.se-card {
  background: #fafbfd; border: 1px solid #eef1f6; border-radius: 10px; padding: 12px;
...
.se-hbtn {
  ...
  color: #94a3b8; transition: all 0.15s ease; font-size: 14px;
}
...
.add-step-btn {
  ...
  padding: 10px; border: 1.5px dashed #d4dbe6; border-radius: 10px;
  background: transparent; color: var(--plaza-text-muted);
  font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.18s ease;
}
.add-step-btn:hover { border-color: var(--plaza-accent); color: var(--plaza-accent); background: #f8faff; }
...
.dlg-btn.cancel:hover { color: var(--plaza-text); border-color: #b9c4d4; }
...
.dv-ver { font-family: var(--font-mono); font-size: 12px; color: #94a3b8; font-weight: 600; }
.dv-source { font-size: 11px; color: var(--plaza-text-muted); background: #f1f5f9; padding: 2px 8px; border-radius: 6px; }
...
.dv-step { background: #fafbfd; border: 1px solid #eef1f6; border-radius: 10px; padding: 12px 14px; }
...
.dvs-time { font-family: var(--font-mono); font-size: 11px; color: #94a3b8; margin-left: auto; }
...
.dvs-item-tag { background: #f1f5f9; padding: 2px 7px; border-radius: 4px; font-size: 11px; }
